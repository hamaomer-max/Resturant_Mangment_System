        ...
        <div class="app" >
                ...
                <div class="d-flex  align-items-center justify-content-between px-4">
                    <a href="" class="logo  align-items-center">
                        <span class="d-none d-lg-block">
                            <span class="fs-4 mr-1"> Chef Panel</span>
                        </span>
                    </a>
            ...
            <aside id="sidebar" class="sidebar ">
                <ul class="sidebar-nav" id="sidebar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link collapsed {{ in_array(Route::currentRouteName(), ['server.home']) ? 'bg-primary bg-opacity-25 d-block' : '' }}"
                                href="{{ route('chef.home') }}">
                                <i class="bi bi-grid mx-1"></i> <span> Dashboard</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link collapsed {{ in_array(Route::currentRouteName(), ['order.home']) ? 'bg-primary bg-opacity-25 d-block' : '' }}"
                                href="{{ route('order.home') }}">
                                <i class="bi bi-box-arrow-in-down mx-1"></i> <span> Orders</span>
                            </a>
                        </li>
